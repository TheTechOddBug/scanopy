use super::{
    application_builder::ApplicationBuilder, context::TopologyContext, l2_builder::L2Builder,
    l3_builder::L3Builder, workloads_builder::WorkloadsBuilder,
};
...
pub fn builder_for_view(view: TopologyView) -> Box<dyn ViewBuilder> {
    match view {
        ...
        TopologyView::Workloads => Box::new(WorkloadsBuilder),
