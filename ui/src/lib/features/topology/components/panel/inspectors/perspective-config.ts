 ...
 * Reads from perspective metadata generated by the backend via `make generate-fixtures`.
 */
export function getInspectorConfig(perspectiveId: string): PerspectiveInspectorConfig {
	const meta = perspectives.getMetadata(perspectiveId) as {
		inspector_config?: PerspectiveInspectorConfig;
	} | null;
